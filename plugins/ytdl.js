...
conn.sendMessage(m.chat, `*⏯ ️Descargador By ©AsianBot𖠌 ⏯️*\n\n*🔥Titulo:* ${title}\n*📂Tamaño del archivo:* ${filesizeF}` , 'conversation', {quoted: m, thumbnail: global.thumb, contextInfo:{externalAdReply: {title: 'Everything fine, right?', body: `© ${conn.user.name}`, sourceUrl: 'enviando...', thumbnail: y}}})
